...
} = require("../validations/enrolement");
...
router.put(
  "/enrolement/AdditionalSection/:id",
  enrolement.updateAdditionalSection
);
router.get(
  "/enrolement/AdditionalSection/:id",
  enrolement.getAdditionalSection
);
router.put(
  "/enrolement/registration/:enrolementId/:sessionId",
  enrolement.updateRegistration,
  enrolement.updateSessionCapacity,
  enrolement.updateRegistration
);
