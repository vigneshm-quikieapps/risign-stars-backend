...
const {createRoleValidationRules, updateRoleValidationRules}  = require("../validations/role")
...
//update route
router.put("/roles/:roleId", updateRoleValidationRules(), validate, role.update);
