...
const createMemberValidationRules = () => {
    return [
      ...
      body("membership.*.businessId", "min length should be 2").custom(businessIdValidation),
  ...
  const updateMemberValidationRules = () => {
    return [
      ...
      body("membership.*.businessId", "min length should be 2").optional().custom(businessIdValidation),
